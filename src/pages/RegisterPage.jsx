    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center px-5 py-16">
            ...
            <div className="w-full max-w-md">
                <h1 className="text-2xl font-black uppercase tracking-tight text-black text-center mb-1">Create an Account</h1>
                <p className="text-sm text-gray-400 text-center mb-8">
                    Already have an account?{" "}
                    <Link to="/login" className="text-black font-semibold hover:text-red-600 transition-colors underline">Log in</Link>
                </p>
                ...
                <form onSubmit={handleSubmit} autoComplete="on" className="flex flex-col gap-4">
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input type="text" name="lastName" value={form.lastName} onChange={handleChange}
                                placeholder="Khan" autoComplete="family-name"
                                className="w-full border border-gray-300 px-4 py-3 text-sm font-medium text-black placeholder-gray-300 outline-none focus:border-black transition-colors rounded-sm" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-xs font-black uppercase tracking-widest text-gray-500">Phone (Optional)</label>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">Must be at least 6 characters</p>
                    </div>
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? "SENDING CODE..." : "CREATE AN ACCOUNT"}
                    </button>
                </form>

                <p className="text-center text-xs text-gray-400 mt-5">
                    By creating an account, you agree to our{" "}
                    <span className="text-black font-semibold cursor-pointer hover:text-red-600">Terms & Conditions</span>
                </p>
            </div>
        </div>
    );
